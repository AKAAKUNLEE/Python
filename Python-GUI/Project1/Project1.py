...
class  Project1:
    def __init__(self,root,isTKroot = True):
        ...
        Fun.SetControlPlace(uiName,'Button_2',0,2,48,48)
        Button_2.configure(bg = "#EFEFEF")
        Project1_cmd.ElementBGArray[2]=Image.open("Ico/ico_new.png").convert('RGBA')
        Project1_cmd.ElementBGArray_Resize[2] = Project1_cmd.ElementBGArray[2].resize((48, 48),Image.LANCZOS)
        Project1_cmd.ElementBGArray_IM[2] = ImageTk.PhotoImage(Project1_cmd.ElementBGArray_Resize[2])
        Button_2.configure(image = Project1_cmd.ElementBGArray_IM[2])
        Button_2.configure(command=lambda:Project1_cmd.Button_2_onCommand(uiName,"Button_2"))
        Button_3 = tkinter.Button(Form_1,text="Button")
        Fun.Register(uiName,'Button_3',Button_3)
        Fun.SetControlPlace(uiName,'Button_3',48,2,48,48)
        Button_3.configure(bg = "#EFEFEF")
        Project1_cmd.ElementBGArray[3]=Image.open("Ico/ico_open.png").convert('RGBA')
        Project1_cmd.ElementBGArray_Resize[3] = Project1_cmd.ElementBGArray[3].resize((48, 48),Image.LANCZOS)
        Project1_cmd.ElementBGArray_IM[3] = ImageTk.PhotoImage(Project1_cmd.ElementBGArray_Resize[3])
        Button_3.configure(image = Project1_cmd.ElementBGArray_IM[3])
        ...
        Project1_cmd.ElementBGArray[4]=Image.open("Ico/ico_save.png").convert('RGBA')
        Project1_cmd.ElementBGArray_Resize[4] = Project1_cmd.ElementBGArray[4].resize((48, 48),Image.LANCZOS)
        Project1_cmd.ElementBGArray_IM[4] = ImageTk.PhotoImage(Project1_cmd.ElementBGArray_Resize[4])
        Button_4.configure(image = Project1_cmd.ElementBGArray_IM[4])
        Button_4.configure(command=lambda:Project1_cmd.Button_4_onCommand(uiName,"Button_4"))
        ...
        Project1_cmd.ElementBGArray[5]=Image.open("Ico/ico_run.png").convert('RGBA')
        Project1_cmd.ElementBGArray_Resize[5] = Project1_cmd.ElementBGArray[5].resize((48, 48),Image.LANCZOS)
        Project1_cmd.ElementBGArray_IM[5] = ImageTk.PhotoImage(Project1_cmd.ElementBGArray_Resize[5])
        Button_5.configure(image = Project1_cmd.ElementBGArray_IM[5])
        Button_5.configure(command=lambda:Project1_cmd.Button_5_onCommand(uiName,"Button_5"))
        ...
        文件.add_command(label="新建",command=lambda:Project1_cmd.Menu_新建(uiName,"新建"))
        文件.add_command(label="打开",command=lambda:Project1_cmd.Menu_打开(uiName,"打开"))
        文件.add_command(label="保存",command=lambda:Project1_cmd.Menu_保存(uiName,"保存"))
        文件.add_command(label="另存为",command=lambda:Project1_cmd.Menu_另存为(uiName,"另存为"))
        文件.add_command(label="退出",command=lambda:Project1_cmd.Menu_退出(uiName,"退出"))
        MainMenu.add_cascade(label="文件",menu=文件)
        编辑=tkinter.Menu(MainMenu,tearoff = 0)
        编辑.add_command(label="剪切",command=lambda:Project1_cmd.Menu_剪切(uiName,"剪切"))
        编辑.add_command(label="拷贝",command=lambda:Project1_cmd.Menu_拷贝(uiName,"拷贝"))
        编辑.add_command(label="粘贴",command=lambda:Project1_cmd.Menu_粘贴(uiName,"粘贴"))
        MainMenu.add_cascade(label="编辑",menu=编辑)
        MainMenu.add_command(label="运行",command=lambda:Project1_cmd.Menu_运行(uiName,"运行"))
        帮助=tkinter.Menu(MainMenu,tearoff = 0)
        帮助.add_command(label="关于",command=lambda:Project1_cmd.Menu_关于(uiName,"关于"))
    ...
    def Configure(self,event):
        ...
        if self.root == event.widget:
            ...
            uiName = self.uiName
            Project1_cmd.Form_1_onConfigure(event,self.uiName,"Form_1")
